...
func create_result_item_grid(inventory_data: CraftingResultInventoryData) -> void:
	...
	for slot in inventory_data.inventory_slots:
		...
		new_slot.crafting_result_slot_clicked.connect(inventory_data.on_crafting_result_slot_clicked)
